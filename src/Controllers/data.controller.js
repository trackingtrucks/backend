...
export const subirDatosOBD = async (req, res) => {
    try {
        ...
        const nuevosDatosOBD = new DatosOBD2({ vehiculo: {id : vehiculo._id}, $push: { fuelLevel: {fuelLevel}, RPM: {RPM}, speed: {speed}, coolantTemperature: {coolantTemperature}, pendingTroubleCodes: {pendingTroubleCodes} } });
