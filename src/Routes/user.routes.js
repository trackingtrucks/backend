...
rutas.post("/turno/crear", [auth.verifyToken, auth.onlyGestor, verify.turnoYaCreado, verify.fechaValida], Users.crearTurno) //Crea un turno
rutas.put('/turno/asignar', [auth.verifyToken, auth.onlyGestor, verify.conductorNoEncontrado, verify.turnoNoCreado], Users.asignarTurno);//Asignar un usuario a un turno

rutas.patch("/entrega/empezar", [auth.verifyToken, auth.onlyConductor], Users.empezarEntrega); //Empezar una entrega
rutas.patch("/entrega/terminar", [auth.verifyToken, auth.onlyConductor], Users.terminarEntrega); //Finalizar una entrega
